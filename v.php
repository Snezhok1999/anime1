<?php include "./header.php" ?>
		<main>
			<ul class='list'>
					...
					$otpr = "SELECT * FROM `Anime` where `id` = 9";
				...
				<center><iframe class='video video1' width="730" height="411" src="https://www.youtube.com/embed/xT9-R4w5ydk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
				<center><iframe class='video video2' width="730" height="411" src="https://www.youtube.com/embed/uJBg1Ae-xAM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
	...
	if(isset($_SESSION['username']) ) { ?>
		...
		<form action="new_comment.php" method="POST">
			<input type="hidden" name="id_anime" value='9'>
	...
	$query = "SELECT * FROM anime_comments WHERE  id_anime  = 9";
	...
	<?php }	
				...
				$otpr1 = "SELECT * FROM `anime_comments` where id_anime = 9";
		...
		set score_anime = $average_score where id=9") or die('Error'.mysqli_error($cann));
	?>
		</main>
