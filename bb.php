<?php include "./header.php" ?>
		<main>
			<ul class='list'>
					...
					$otpr = "SELECT * FROM `Anime` where `id` = 1";
	...
	if(isset($_SESSION['username']) ) { ?>
		...
		<form action="new_comment.php" method="POST">
			<input type="hidden" name="id_anime" value='1'>
	...
	$query = "SELECT * FROM anime_comments WHERE  id_anime  = 1";
	...
	<?php }	
				...
				$otpr1 = "SELECT * FROM `anime_comments` where id_anime = 1";
		...
		set score_anime = $average_score where id=1") or die('Error'.mysqli_error($cann));
	?>
		</main>
