<?php include "./header.php" ?>
		<main>
			<ul class='list'>
					...
					$otpr = "SELECT * FROM `Anime` where `id` = 5";
				...
				<div class=bookmarks>
					<form method="POST" action="<?php $url ?>">
						<center><input type="submit" name="bookmark" style='font-size: 20px;' value="Добавить в закладки" class='a-q h2'>
				...
				<center><iframe class='video video1' width="730" height="411" src="https://www.youtube.com/embed/DbKV97Nuhso" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
				<center><iframe class='video video2' width="730" height="411" src="https://www.youtube.com/embed/oFrIONQqD6w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
	...
	if(isset($_SESSION['username']) ) { ?>
		...
		<form action="new_comment.php" method="POST">
			<input type="hidden" name="id_anime" value='5'>
	...
	$query = "SELECT * FROM anime_comments WHERE  id_anime  = 5";
	...
	<?php }	
				...
				$otpr1 = "SELECT * FROM `anime_comments` where id_anime = 5";
		...
		set score_anime = $average_score where id=5") or die('Error'.mysqli_error($cann));
	?>
		</main>
